	...
	<section class="content header">
		...
		<section class="content">
			<div class="box box-solid">
				<div class="row">
					<div class="col-md-12">
						<a href="<?php echo base_url();?>Productos/add" class="btn btn-primary btn-flat"><span class="fa fa-plus"></span>Agregar Producto</a>
					</div>
				</div>
				<hr>
				<div class="row">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title"><center>Informacion del producto</center></h2>
      </div>
